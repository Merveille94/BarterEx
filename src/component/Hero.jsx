...
import Banner from "./Banner.jsx"; // Import the data
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-1 gap-2">
                    <div className="col-span-1 row-span-1 gap-y-3 p-8">
                        <div className="flex flex-col justify-center items-start">
                            ...
                            <Link to={'/signup'}><h2 className='flex items-center justify-center bg-gray-600 hover:bg-gray-800 hover:text-slate-200 text-slate-100 md:px-auto py-2 px-10 rounded-xl mt-4'>
                                Get Started !</h2></Link>
                        </div>
                    </div>
